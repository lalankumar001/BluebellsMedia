...
<Route exact path="/our_packages" Component={Package}/>
      ...
      <div className='flex fixed-bottom'>
        <a href="https://wa.me/7759958233"  className='btn btn-success shadow mx-2 mb-2' target="_blank" rel="noopener noreferrer">  <i className="fab fa-whatsapp mr-2"></i> <span className='fs-3'> <MdWhatsapp /> </span></a>
        </div>
      <Footer />
     </div>
  )
